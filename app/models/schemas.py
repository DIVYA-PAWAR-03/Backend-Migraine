...
class ReportAnalysisDetail(BaseModel):
    """Structured report analysis detail."""
    summary: str = Field(..., description="High-level executive summary of report")
    risk_level: RiskLevel = Field(default=RiskLevel.MEDIUM, description="Overall risk level evaluated from report")
    key_findings: List[str] = Field(default=[], description="Key clinical or lab findings")
    migraine_triggers: List[str] = Field(default=[], description="Migraine triggers identified from report")
    recommendations: List[str] = Field(default=[], description="Personalized health & prevention advice")
    disclaimer: str = Field(
        default="This analysis is generated by AI for informational and tracking purposes only. Please consult a qualified healthcare provider for official clinical diagnosis.",
        description="Medical disclaimer"
    )


class ReportAnalysisResponse(BaseModel):
    """Response schema for uploaded report analysis."""
    success: bool = True
    filename: str = Field(..., description="Uploaded file name")
    file_type: str = Field(..., description="Detected file type")
    extracted_text_preview: str = Field(..., description="Preview of extracted report text")
